  ...
  <section>
    <div class="auth_contnair">
      ...
      <div class="auth_number_input_contnair">
        ...
        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum02" ref="num02" @keydown.delete="delite01">

        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum03" ref="num03" @keydown.delete="delite02">

        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum04" ref="num04" @keydown.delete="delite03">

        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum05" ref="num05" @keydown.delete="delite04">

        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum06" ref="num06" @keydown.delete="delite05">
