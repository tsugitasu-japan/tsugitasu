  ...
  <section>
    <div class="auth_contnair">
      ...
      <div class="auth_number_input_contnair">
        ...
        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum02" ref="num02">

        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum03" ref="num03">

        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum04" ref="num04">

        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum05" ref="num05">

        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum06" ref="num06">
...
export default {
  ...
  watch: {
    // 入力されたらフォーカス移動
    authNum01: function(num) { if (num.length >= 3) { this.$refs.input02.focus() } },
  }
}
</script>
