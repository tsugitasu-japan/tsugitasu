  ...
  <section>
    <div class="auth_contnair">
      ...
      <div class="auth_contnair_top">
        ...
        <button class="repost_auth_code_button">認証コードを再送するze</button>
      </div>
      ...
      <div class="auth_number_input_contnair">
        ...
        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" autofocus v-model="authNum01" ref="num01" @input="numFilter($event.target.value)">
...
export default {
  ...
  methods: {
    ...
    delete01(num) { if (num.target.value == "") { this.$refs.num01.focus() } },
    delete02(num) { if (num.target.value == "") { this.$refs.num02.focus() } },
    delete03(num) { if (num.target.value == "") { this.$refs.num03.focus() } },
    delete04(num) { if (num.target.value == "") { this.$refs.num04.focus() } },
    delete05(num) { if (num.target.value == "") { this.$refs.num05.focus() } },
    delete06(num) { if (num.target.value == "") { this.$refs.num06.focus() } },
