    ...
    <div class="auth_contnair">
      ...
      <div class="auth_number_input_contnair">
        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" autofocus v-model="authNum01">
        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum02">
        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum03">
        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum04">
        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum05">
        <input type="tel" class="auth_number_input" maxlength="1" autocorrect="off" autocapitalize="off"
          autocomplete="off" spellcheck="false" v-model="authNum06">
      </div>
